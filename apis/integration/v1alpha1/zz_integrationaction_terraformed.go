...
// GetInitParameters of this IntegrationAction
func (tr *IntegrationAction) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IntegrationAction
func (tr *IntegrationAction) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
