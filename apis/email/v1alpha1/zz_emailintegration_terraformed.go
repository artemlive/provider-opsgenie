...
// GetInitParameters of this EmailIntegration
func (tr *EmailIntegration) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EmailIntegration
func (tr *EmailIntegration) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
