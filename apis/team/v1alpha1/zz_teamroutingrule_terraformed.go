...
// GetInitParameters of this TeamRoutingRule
func (tr *TeamRoutingRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TeamRoutingRule
func (tr *TeamRoutingRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
