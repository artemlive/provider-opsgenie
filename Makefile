...
PROJECT_REPO ?= github.com/macpaw/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 0.6.37
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= opsgenie
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-opsgenie_v0.6.37
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/opsgenies/03-delete.yaml.tmpl.
